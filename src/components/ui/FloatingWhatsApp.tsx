  ...
  return (
    <div className="fixed bottom-6 right-6 z-[100]">
      ...
      <a
        ...
        className="relative flex items-center justify-center w-[52px] h-[52px] lg:w-[60px] lg:h-[60px] rounded-full bg-[#25D366] shadow-lg hover:scale-110 transition-transform duration-200"
      >
        {/* Pulse ring */}
        <span
